    ...
    stages {
        ...
        stage('Build') {
            steps {
                ...
                npm run build
                cd ../../../
                cp -r ./src/main/frontend/build target/classes/static
        ...
        stage('Publish') {
            ...
            steps {
                script {
                    ...
                    sh 'docker container rm prodent --force'
                    sh 'docker run -dp 8083:8081  -v /home/pi/h2-data:/h2-data --name prodent sevgulnl/prodent-profiling'
